...
public class TodoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //todoAdp = new ArrayAdapter<TodoBean>(this,android.R.layout.simple_list_item_1);
    ...
    class ListItemAdapter extends ArrayAdapter<TodoBean>{
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if(view == null) {
                ...
                //holder.date.setText(tb.getDate().substring(0, 5));
                ...
                try {
                    ...
                    if (tododate.compareTo(today) < 0) {
                        ...
                        holder.date.setTextColor(ContextCompat.getColor(ctx,android.R.color.black));
                    }
                ...
                holder.edit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        intent.setClass(ctx, EditItemActivity.class);
                        intent.putExtra(ITEM_NAME, tb);
